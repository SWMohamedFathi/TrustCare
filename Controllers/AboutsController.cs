...
namespace TrustCare.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AboutId,HeadingOne,Content,ImagePath")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("AboutId,HeadingOne,Content,ImagePath")] About about)
        {
            if (id != about.AboutId)
            {
                return NotFound();
